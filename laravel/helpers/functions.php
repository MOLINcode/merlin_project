       ...
       /* $i = 1;
        ...
        foreach ($tree as $v) {
            if (checkChild($v)) {
                $html .= "<tr>";
                $html .= "<td>".$i."</td>";
                $html .= "<td>|--".$v['pid'].$v['cate_name']."</td>";
                $html .= "<td>".$v['as_name']."</td>";
                $html .= "<td>".$v['pid']."</td>";
                $html .= "<td>".$v['created_at']."</td>";
                $html .= '<td>';
                $html .= '<div class="change"><a href="" data-toggle="modal" data-target="#create_modal" class="editCategory" >';
                $html .='<img src="{{asset(\'/img/common/edit.png\')}}" alt="编辑"></a><img class="delCategory" src="{{asset(\'/img/common/del.png\')}}" alt="删除">';
                $html.='</div></td>';
                $html .= "</tr>";
                treeList($v['child']);
            } else {
