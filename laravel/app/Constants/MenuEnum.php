...
class MenuEnum
{
    ...
    private static $menuGroups = array(
        self::MENU_GROUP_ACCOUNT  => 'account_info',
        self::MENU_GROUP_BUY      => 'purchase',
        self::MENU_GROUP_TEMPLATE => 'template_management',
    );
    ...
    {
        foreach(self::$menuGroups as $k=>$v)
        {
            $re[$k] = Lang::get('system.'.$v);
        }
